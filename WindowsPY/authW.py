...
class Ui_AuthMainWindow(object):
    def setupUi(self, AuthMainWindow):
        ...
        AuthMainWindow.resize(1000, 800)
...
"font-size: 13pt;")
    ...
    def retranslateUi(self, AuthMainWindow):
        ...
        self.label.setText(_translate("AuthMainWindow", "<html><head/><body><p align=\"center\"><span style=\" fon3t-size:23pt;\">Введите Логин и Пароль</span></p></body></html>"))
