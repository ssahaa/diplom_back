...
# Form implementation generated from reading ui file 'ArgeementReductTP.ui'
#
...
"font-size: 15px;")
    ...
    def retranslateUi(self, AgreementNewTP):
        ...
        self.labelNewName.setText(_translate("AgreementNewTP", "текст"))
        self.label_8.setText(_translate("AgreementNewTP", "Новое наименование"))
        self.labelUserComment.setText(_translate("AgreementNewTP", "текст"))
        self.label_4.setText(_translate("AgreementNewTP", "ГОСТ"))
        ...
        self.labelGOST.setText(_translate("AgreementNewTP", "текст"))
